...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=bagreda-vmw&repo=tanzu-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=bagreda-vmw&repo=tanzu-java-web-app'
